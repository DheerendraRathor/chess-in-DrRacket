...
source files:
1. run.ss- main file that has to be executed.
2. project.rkt- file that contains the backbone of the project.
3. chess.ss- contains graphics part and networking.
4. bitmaps.ss- contains all the images required in the code.

instruction: all the source files should be in pretty big language except
bitmaps.ss.
...
3. For playing with a human opponent click on '2 Player'.  
   ...
   Unlimited time and leave desired time unchanged. 
   Click on start and here it goes.
...
5. Well you know well about 'HELP' Button, it will show you thing.
6. And if enjoyed the game and want to thank the creaters than 
